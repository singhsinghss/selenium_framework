...
public class RandomScenariosTest extends CommonTest {
 ...
 // @Test (priority = 1)
  public void openHomeTab_TC33(Method name) throws IOException
  {
	  ...
	  CommonTest.test.info("Open Home Page: TC33 : "+name.getName()+" :object created for RandomScenarios Page");
  ...
  //@Test(priority=2)
  public void editProfile_TC34(Method name) throws IOException
  {
	  WebDriver driver=CommonTest.getDriver();
	  RandomScenariosPage RCP=new RandomScenariosPage(driver);
	  CommonTest.test.info("Edit profile Page: TC34 : "+name.getName()+" :object created for RandomScenarios Page");
	  RCP.openHomeTab_TC33(driver);
  ...
  public void removeTab_TC35(Method name) throws IOException
  {
	  WebDriver driver=CommonTest.getDriver();
	  RandomScenariosPage RCP=new RandomScenariosPage(driver);
	  CommonTest.test.info("Remove tab : TC35 : "+name.getName()+" :object created for RandomScenarios Page");
	  RCP.openHomeTab_TC33(driver);
